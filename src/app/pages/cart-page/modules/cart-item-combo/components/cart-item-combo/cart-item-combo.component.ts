...
@Component({
  selector: 'app-cart-item-combo',
  changeDetection: ChangeDetectionStrategy.OnPush,
  templateUrl: './cart-item-combo.component.html',
  styleUrls: ['./cart-item-combo.component.scss']
})
export class CartItemComboComponent implements OnChanges, OnInit {
  ...
  @Output() renewPeriodChangeEvent = new EventEmitter<{item: CartComboItemModel, value: string | null}>();
