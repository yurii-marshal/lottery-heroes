...
@Component({
  selector: 'app-top-bundles-item',
  templateUrl: './top-bundles-item.component.html',
  styleUrls: ['./top-bundles-item.component.scss']
})
export class TopBundlesItemComponent implements OnChanges {
